...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Введите команду: \n" +
                "1 - добавить жиивотное, 2 - удалить животное, 3 - получить инфо по животному, 4 - потревожить животное\n" +
                "5 - получить инфо по всем животным, 6 - потревожить всех, 7 - попытаться запустить в небо, 8 - погладить, 9 - дрессировать:");
        int ex = scan.nextInt();
        switch (ex) {
            case 1:
